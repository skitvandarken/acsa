...
@Component({
  selector: 'app-politicas-id-duediligence',
  imports: [TranslatePipe, MenuComponent, RodapeComponent],
  templateUrl: './politicas-id-duediligence.component.html',
  styleUrl: './politicas-id-duediligence.component.css'
})
export class PoliticasIdDuediligenceComponent {
